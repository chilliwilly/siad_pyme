...
<link rel="stylesheet" href="<?php echo base_url()?>plugins/yadcf/chosen.min.css"/>
...
<script type="text/javascript" src="<?php echo base_url(); ?>plugins/yadcf/chosen.jquery.min.js"></script>
...
<section class="content">
  ...
  <div class="box">
    <div class="box-header with-border">
      <h3 class="box-title">Ordenes Ingresadas</h3>
    </div>
    ...
    <div class="box-body">
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="col-xs-4">
            <input type="text" id="txtFoliosIn"/>
            <input type="button" id="btnBuscarFolios" value="press me"/>
          </div>
        </div>
      </div>
      ...
      <!-- col-xs-12 style="float: none; display: block; margin-left: auto; margin-right: auto;"-->
        <div class="col-xs-6">
          ...
          <div id="exportBtn" class="col-xs-3">
            <!-- aqui va el exportar boton que se agrega automaticamente -->
          </div>
        </div>
      </div>
  ...
  $(document).ready(function(){
    ...
    $('#ordenes').dataTable({
    ...
    }).yadcf([
      {
        ...
        filter_container_id: "filtroFolio",
        select_type: "chosen",
        filter_default_label: 'Seleccione Folios',
        select_type_options: {width: '194px'}
      },
      {
        column_number : [4],
        filter_type: "multi_select",
        filter_container_id: "filtroCliente",
        select_type: "chosen",
        filter_default_label: 'Seleccione Cliente',
        select_type_options: {width: '194px'}
      },
      {
        column_number : [5],
        filter_type: "multi_select",
        filter_container_id: "filtroComuna",
        select_type: "chosen",
        filter_default_label: 'Seleccione Comuna',
        select_type_options: {width: '194px'}
      },
      {
        column_number : [6],
        filter_type: "multi_select",
        filter_container_id: "filtroAliado",
        select_type: "chosen",
        filter_default_label: 'Seleccione Aliado',
        select_type_options: {width: '194px'}
      },
      {
        column_number : [7],
        filter_type: "multi_select",
        filter_container_id: "filtroTrabajo",
        select_type: "chosen",
        filter_default_label: 'Seleccione Trabajo',
        select_type_options: {width: '194px'}
      },
      {
        column_number : [8],
        filter_type: "multi_select",
        filter_container_id: "filtroEstado",
        select_type: "chosen",
        filter_default_label: 'Seleccione Estado',
        select_type_options: {width: '194px'}
      },
      {
        column_number : [9],
        filter_type: "multi_select",
        filter_container_id: "filtroAdmin",
        select_type: "chosen",
        filter_default_label: 'Seleccione CCOM',
        select_type_options: {width: '194px'}
      }
    ]);

    var buttons = new $.fn.dataTable.Buttons($('#ordenes').dataTable(), {
      buttons: [{
        extend:'excelHtml5',
        text:'<span class="glyphicon glyphicon-export"></span> Exportar',
        className: 'btn btn-warning',
        exportOptions: {
            columns: [0,1,17,2,4,5,6,7,8,9,11,12,13,14,15,16,18,19,20,21,22]
        },
        title: 'Ordenes_Pendientes_'+new Date().toJSON().slice(0,10)+'_'+new Date().toTimeString().slice(0,5)
      }]
